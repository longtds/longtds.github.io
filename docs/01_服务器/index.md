...
| 文章 | 主题 |
|:---|:---|
| [服务器Linux安装](01-服务器Linux安装.md) | 光盘/U盘制作 → RAID → BIOS → 安装 |
| [PXE批量自动安装](02-PXE批量自动安装.md) | DHCP/TFTP/HTTP + Kickstart/Autoinstall |
| [物理设备详解](28-物理设备详解.md) | 服务器/存储/网络/机柜/BMC/GPU/硬件监控/采购 |
