...
date: 2026-07-02T08:36:00.900965+08:00
source: 美团技术团队
domain: AI 基础设施
url: https://tech.meituan.com/2026/06/29/LongCat-VitaBench-2.0.html
...
| 领域 | AI 基础设施 |
| 来源 | 美团技术团队 |
| 原文标题 | LongCat 开源 VitaBench 2.0：长期动态智能体基准新标杆 |
| 原文 | [打开原文](https://tech.meituan.com/2026/06/29/LongCat-VitaBench-2.0.html) |
...
![LongCat 开源 VitaBench 2.0：长期动态智能体基准新标杆](https://p0.meituan.net/meituantechblog/0679d7f442a603b8d65c2c7e59625131464734.jpg)
...
### [01 设计原理：VitaBench 2.0的三维解构](https://tech.meituan.com/2026/06/29/LongCat-VitaBench-2.0.html#_01-设计原理-vitabench-2-0的三维解构)

能得出这些结论，得益于VitaBench 2.0的核心设计。它不再是简单的问答，而是围绕三大创新构建了一个前所未有的评测体系。

![图1：VitaBench 2.0 概览图](https://p0.meituan.net/meituantechblog/ecfdc52ee4ab7253a877d5df75217f21127484.webp)

#### [1.1 搭建“人生副本”：让

AI在真实用户轨迹中接受考验](https://tech.meituan.com/2026/06/29/LongCat-VitaBench-2.0.html#_1-1-搭建-人生副本-让ai在真实用户轨迹中接受考验)
...
![图2：VitaBench 2.0 用户画像统计图](https://p0.meituan.net/meituantechblog/54c8ca3a15f23f55b88d079885aedf63148034.webp)

![图3：VitaBench 2.0 用户偏好统计图](https://p0.meituan.net/meituantechblog/765450b81465c59972ae583ca0946e64149788.webp)
...
#### [1.2 引入“时间标尺”：将持续理解作为核心目标](https://tech.meituan.com/2026/06/29/LongCat-VitaBench-2.0.html#_1-2-引入-时间标尺-将持续理解作为核心目标)
...
AI的两种记忆模式](https://tech.meituan.com/2026/06/29/LongCat-VitaBench-2.0.html#_1-3-设立-记忆擂台-对决ai的两种记忆模式)
...
### [02 核心洞察：用数据看清模型的短板](https://tech.meituan.com/2026/06/29/LongCat-VitaBench-2.0.html#_02-核心洞察-用数据看清模型的短板)

VitaBench 2.0不仅给出了总分，更用数据揭示了模型们犯错的具体原因。如表1所示，这是主要模型在不同记忆设置下的性能排行榜。

![表1：主要模型在不同记忆设置下的性能表现](https://p1.meituan.net/meituantechblog/521cabb68ee8fad43452344cba3bb4a1649960.webp)
...
![图4：模型性能随任务序列（时间）的衰减分析](https://p1.meituan.net/meituantechblog/212aa3a638a9bcacbbcadea7718d77d628306.webp)
...
![图5：开启/关闭思考模式下的模型性能与效率](https://p0.meituan.net/meituantechblog/5e633bfcc648e2d8d5b34eaaa9469a7048792.webp)

洞察三：AI普遍缺乏“主动沟通”的意愿

模型普遍缺乏在信息不足时主动提问的“眼力见”。所有模型家族在需要主动提问的任务上，得分都出现了“断崖式”下跌。例如，Claude家族的平均分从46.0骤降至27.4。这表明，AI倾向于“想当然”，而不是在不确定时“多问一句”。

![图6：模型在主动性任务上的性能表现](https://p0.meituan.net/meituantechblog/dc9b1835d1107a759336fabf3ba6870074674.webp)
...
![图7：在提供真实偏好下的模型性能](https://p1.meituan.net/meituantechblog/cf75832fa9983f74bb404bf899cac91223446.webp)
...
![图8：模型失败模式分析（DeepSeek家族为例）](https://p1.meituan.net/meituantechblog/8cdd5784d215584793d4eabed47c184f59698.webp)

### [03 总结：定义下一代智能体评测范式](https://tech.meituan.com/2026/06/29/LongCat-VitaBench-2.0.html#_03-总结-定义下一代智能体评测范式)
...
- 项目主页： [https://vitabench2.github.io/](https://vitabench2.github.io/)
- 论文链接： [https://arxiv.org/abs/2605.27141](https://arxiv.org/abs/2605.27141)
- GitHub： [https://github.com/meituan-longcat/vitabench-2.0](https://github.com/meituan-longcat/vitabench-2.0)
- HuggingFace：[https://huggingface.co/datasets/meituan-longcat/VitaBench-2.0](https://huggingface.co/datasets/meituan-longcat/VitaBench-2.0)
